...
/* Muestro el spinner por mientras que se cargan los pokemons */
function showSpinner() {
  spinner.classList.add("spinner");
  containerPokemons.style.display = "none";
  pages.style.display = "none";
}
/* Quito el spinner luego de que se cargan los pokemons */
...
/* Llamo a todas las funciones para que comiencen a funcionar en cuanto cargue la página */
